        ...
        <>
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="costOfSale" onChange={(e) => onChange(e)} value={valoration} />
                    <input type="text" name="valoration" onChange={(e) => onChange(e)} value={porcentajeDefault} />
