        ...
        <>
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="priceNetoSale" onChange={(e) => onChange(e)} value={valoration} />
