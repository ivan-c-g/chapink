        ...
        <>
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    <select name="select" onChange={(e) => onChange(e)} defaultValue={typeProperty}>
                    ...
                    <input type="string" name="propertyPrice" value={propertyPrice} onChange={(e) => onChange(e)} />

                    <label>Coste de adquisición:
                        {propertyPrice && <p>{propertyPrice * 2}</p>}
                    </label>
