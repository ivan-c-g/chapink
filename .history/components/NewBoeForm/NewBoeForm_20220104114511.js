...
export const NewBoeForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(street)
        try {
            const user = await boeService.createBoe({ street, number, strais, plant, door, typeProperty, propertyPrice, broker, licenseAndFees, reform, holdingCost, interiorDesign, getSubtotal() })
        } catch (error) {
            console.log(error)
        }
    }
