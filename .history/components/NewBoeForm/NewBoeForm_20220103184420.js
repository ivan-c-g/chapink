        ...
        <>
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    <label>Subtotal: {
                        Number.parseFloat(propertyPrice) + Number.parseFloat(costAcquistion) + Number.parseFloat(reform, 10) +
                        Number.parseFloat(broker) + Number.parseFloat(licenseAndFees) + Number.parseFloat(holdingCost) + Number.parseFloat(interiorDesign)
                    }</label>
