            ...
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    */}
                    ...
                    <input type="number" name="costAcquisition" onChange={(e) => onChange(e)} value={typeProperty === "oficina" || typeProperty === "local" ? (propertyPrice * 0.071).toFixed(2) : (propertyPrice * 0.032).toFixed(2)} disabled />
