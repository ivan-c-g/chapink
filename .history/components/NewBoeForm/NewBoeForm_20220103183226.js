...
export const NewBoeForm = () => {
    ...
    const getCostAcqusition = (propertyPrice, porcentaje) => {
        let priceProperty = propertyPrice * porcentaje
        setPropertyPrice(priceProperty)
    }
        ...
        <>
            <ContainerForm>
                <form onSubmit={handleSubmit}>
                    ...
                    <label>Coste de adquisición:
                        {
                            typeProperty === "oficina" || typeProperty === "local" ?
                                propertyPrice && <p> 7.10% {getCostAcqusition(propertyPrice, 7.10)}</p> :
                                <p> 3.2% {getCostAcqusition(propertyPrice, 0.32)}</p>
                        }
                    </label>
                    ...
                    <label>Subtotal: {
                        Number.parseInt(propertyPrice) + Number.parseInt(costAcquistion) + Number.parseFloat(reform, 10)
                    }</label>
